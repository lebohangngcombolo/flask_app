from flask import Flask, request, jsonify, send_file, current_app, send_from_directory, Response
...
CORS(app, resources={r"/admin/*": {"origins": "http://localhost:4200"}}, supports_credentials=True)
...
def get_user_referral_details(current_user):
    ...
    base_frontend_url = "http://localhost:4200"  # Change to your real frontend
