...
const sidebarItems = [
  ...
  { label: 'Digital Wallet', path: '/dashboard/wallet', icon: CreditCard },
  { label: 'KYC', path: '/dashboard/kyc', icon: CheckCircle },
  { label: 'Beneficiaries', path: '/dashboard/beneficiaries', icon: Users },
  { label: 'Refer & Earn', path: '/dashboard/referrals', icon: Gift },
  { label: 'Stokvel Groups', path: '/dashboard/groups', icon: Briefcase },
  { label: 'Request Payout', path: '/dashboard/claims', icon: DollarSign },
];
