...
export const isAuthenticated = (): boolean => {
  try {
    ...
    // FIXED: Only check if user exists, don't require verification
...
export const getCurrentUser = () => {
  ...
  try {
    ...
    // FIXED: Don't require verification for basic access
    return user;
  } catch {
    return null;
  }
...
// FIXED: Add a separate function to check if user is verified
